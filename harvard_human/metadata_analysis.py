            ...
            for celli in metadata[metadata[cell] & metadata[layer]].iloc:
                try:
                    ...
                    try:
                        ...
                        print('Cell ID: %s is missing from c3_rep_manual' % (celli.name))
                        try:
                            ...
                            print('Cell ID: %s is missing from c2_rep_strict' % (celli.name))
                            try:
                                ...
                                print('Cell ID: %s is missing from c2_rep_manual' % (celli.name))
...
# i = 5
# layer = 'L4'
# cell_id = data[cell][layer]['cell_ids'][0]
